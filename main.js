...
(() => {
  ...
  const DIGITAL = [
    {src:"img/kalyanam.jpg", alt:"Digital artwork 1", title:"Kalyanam", caption:"Wedding Poster — Cultural motifs.",  mw:'40%', mh:'70%', op:'50% 50%' },
    {src:"img/sangeet.jpg", alt:"Digital artwork 2", title:"Sangeet", caption:"Event Poster — Exploring light & shadow.",  mw:'40%', mh:'70%', op:'50% 50%' },
    ...
    {src:"img/book.JPEG", alt:"Digital artwork 4", title:"Lotus", caption:"Book Cover Design",  mw:'40%', mh:'70%', op:'50% 50%' }
  ];
  const HAND = [
