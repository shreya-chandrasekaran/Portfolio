...
(() => {
  ...
  const DIGITAL = [
    {src:"img/kalyanam.jpg", alt:"Digital artwork 1", title:"Kalyanam", caption:"Wedding Poster — Cultural motifs.",  mw:'50%', mh:'70%', op:'50% 50%' },
    {src:"img/sangeet.jpg", alt:"Digital artwork 2", title:"Sangeet", caption:"Event Poster — Exploring light & shadow.",  mw:'50%', mh:'70%', op:'50% 50%' },
    ...
    {src:"img/book.JPEG", alt:"Digital artwork 4", title:"Lotus", caption:"Book Cover Design",  mw:'50%', mh:'70%', op:'50% 50%' }
  ];
  const HAND = [
    ...
    {src:"img/orange.jpg", alt:"Handmade artwork 2", title:"Burnt Orange", caption:"Oil — Glow and contrast.", mw:'60%', mh:'60%', op:'50% 50%'},
    ...
    {src:"img/banana.jpg", alt:"Handmade artwork 4", title:"Tender Arc", caption:"Watercolour — Still life study.", mw:'60%', mh:'60%', op:'50% 50%'}
  ];
